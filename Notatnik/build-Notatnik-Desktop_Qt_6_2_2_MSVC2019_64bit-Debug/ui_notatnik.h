...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/imgs/img/Cut.ico"), QSize(), QIcon::Normal, QIcon::On);
        actionWytnij->setIcon(icon7);
        actionKopiuj = new QAction(MainWindow);
        actionKopiuj->setObjectName(QString::fromUtf8("actionKopiuj"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/imgs/img/Copy.ico"), QSize(), QIcon::Normal, QIcon::Off);
        actionKopiuj->setIcon(icon8);
        actionWklej = new QAction(MainWindow);
        actionWklej->setObjectName(QString::fromUtf8("actionWklej"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/imgs/img/Paste.ico"), QSize(), QIcon::Normal, QIcon::On);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/imgs/img/Find.ico"), QSize(), QIcon::Normal, QIcon::On);
        actionZnajdz->setIcon(icon10);
        ...
        actionZawijanie_wierszy->setChecked(true);
        ...
        textEdit->setLocale(QLocale(QLocale::Polish, QLocale::Poland));
        ...
        menuPomoc->addAction(actionKontakt);
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Notatnik", nullptr));
...
#if QT_CONFIG(shortcut)
        actionPowtorz->setShortcut(QCoreApplication::translate("MainWindow", "Ctrl+Y", nullptr));
#endif // QT_CONFIG(shortcut)
        ...
        actionKontakt->setText(QCoreApplication::translate("MainWindow", "Kontakt", nullptr));
